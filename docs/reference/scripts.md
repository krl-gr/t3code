...
- The DMG build uses `assets/prod/upcomputer-macos-1024.png` as the production app icon source.
- Desktop production windows load the bundled UI from `upcomputer://app/index.html` (not a `127.0.0.1` document URL).
