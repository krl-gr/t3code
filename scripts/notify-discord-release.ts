  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Up.computer prerelease is available for nightly testers."
          : "A new Up.computer latest release is available.",
...
).pipe(Command.withDescription("Post a Up.computer release announcement to Discord."));
