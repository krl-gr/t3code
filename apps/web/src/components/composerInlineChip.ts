...
export const COMPOSER_INLINE_CHIP_CLASS_NAME =
  `inline-flex max-w-full select-none items-center gap-1 rounded-md border border-border/70 bg-accent/40 px-1.5 py-px ${SIDEBAR_LABEL_TEXT_CLASS} ${SIDEBAR_LABEL_COLOR_CLASS} align-middle`;

export const COMPOSER_INLINE_CHIP_ICON_CLASS_NAME = "size-3.5 shrink-0 opacity-85";

export const COMPOSER_INLINE_CHIP_LABEL_CLASS_NAME = "truncate select-none";

export const COMPOSER_INLINE_SKILL_CHIP_CLASS_NAME =
  `inline-flex max-w-full select-none items-center gap-1 rounded-md border border-fuchsia-500/25 bg-fuchsia-500/12 px-1.5 py-px ${SIDEBAR_LABEL_TEXT_CLASS} text-fuchsia-700 align-middle dark:text-fuchsia-300`;
