...
export const ChangedFilesCard = memo(function ChangedFilesCard(props: {
  ...
  return (
    <div
      className="relative mt-4 rounded-2xl bg-card/40 p-2 shadow-xs/5 not-dark:bg-clip-padding after:pointer-events-none after:absolute after:inset-0 after:z-20 after:rounded-2xl after:border after:border-input"
    ...
    >
      <div
        className={cn(
          ...
          expanded && "sticky top-2 z-10 mb-2 bg-card/72 backdrop-blur-md",
        )}
      >
        <button
          type="button"
