    ...
    >
      ...
      >
        {image.previewUrl ? (
          ...
          >
            <ImageIcon className={cn("shrink-0 opacity-70", isComposer ? "size-3" : "size-4")} />
      ...
      <TooltipTrigger
        render={
          <span
            ...
            className={cn(
              "absolute left-1 top-1 z-10 inline-flex items-center justify-center rounded-full border border-amber-500/20 bg-background/90 text-amber-600 shadow-sm",
