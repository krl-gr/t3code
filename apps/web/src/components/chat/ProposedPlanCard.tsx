...
export const ProposedPlanCard = memo(function ProposedPlanCard({
  ...
  return (
    <div className="rounded-[24px] border border-border/80 bg-card/70 p-4 not-dark:bg-[#EFEFEF]/95 sm:p-5">
      ...
      <div className="mt-4">
        <div className={cn("relative", canCollapse && !expanded && "max-h-104 overflow-hidden")}>
          ...
          {canCollapse && !expanded ? (
            <div className="pointer-events-none absolute inset-x-0 bottom-0 h-24 bg-linear-to-t from-card/95 via-card/80 to-transparent not-dark:from-[#EFEFEF]/95 not-dark:via-[#EFEFEF]/80" />
          ) : null}
        </div>
        {canCollapse ? (
